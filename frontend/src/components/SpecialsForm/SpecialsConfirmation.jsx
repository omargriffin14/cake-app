export default function SpecialsConfirmation({ form }) {
  return (
    <div style={{ textAlign: 'center', padding: '1.5rem 0' }}>
      ...
      <p style={{ color: '#7A7070', fontSize: '15px', marginBottom: '2rem', lineHeight: '1.6' }}>
        Thank you, {form.customer_name}! We have received your Mother's Day Minis order and will reach out to you shortly to confirm pickup details.
      </p>
